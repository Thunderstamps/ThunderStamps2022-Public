...
public class TwoBallSecondary extends SequentialCommandGroup{
    ...
    public TwoBallSecondary(
        ...
        //53.5 - 42
        //-88x , 73y
        Trajectory trajectory = loadTrajectroy("BlueSecondaryTwoBallMove1");    
        Trajectory trajectory2 = loadTrajectroy("BlueSecondaryTwoBallMove2");
        ...
        addCommands(
            ...
            new ParallelDeadlineGroup( // Turn towards goal
                ...
                new SequentialCommandGroup(
                    ...
                    new TurnToFieldOrientationCommand(swerveSubsystem, Math.toRadians(-50))
                ),
                new FeederDefaultCommand(mode, feederSubsystem),
                new IntakeDefaultCommand(mode, intakeSubsystem),
                new FlywheelDefaultCommand(mode, flywheelSubsystem)
