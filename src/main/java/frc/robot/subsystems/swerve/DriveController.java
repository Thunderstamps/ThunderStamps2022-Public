...
public class DriveController implements IDriveController {
    ...
    public DriveController(int talonFxCanBusAddress, double motorRevsPerWheelRev) {
        ...
        talon.configSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(true, MAX_CURRENT_A, MAX_CURRENT_A, 0.25));
